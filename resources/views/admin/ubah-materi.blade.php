                    ...
                    <div id="biodata" class="mt-3">
                        ...
                        <form class="card p-4 mb-4" id="materi">
		                    ...
		                    <div class="form-group pt-3">
		                        <button class="btn btn-active btn-block" id="submit" disabled>Ubah Materi</button>
		                    </div>
                        </form>
                    </div>
                </div>
...
@section('script')
	...
	<script>const theory = '{{$theory}}'</script>
    <script src="{{asset('assets/js/date.js')}}"></script>
	<script src="{{asset('api/admin/ubah-materi.js')}}"></script>
@endsection